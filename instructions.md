Use the following instructions to build a modern Portfolio website.
...
Purpose: Display Portfolio's history with an engaging image and story.
...
Purpose: Display Portfolio menu items in an attractive grid layout.
